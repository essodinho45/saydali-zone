            ...
            <div class="col-md-8" id="register_form">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST"
                            @if (\Route::currentRouteName() == 'register') action="{{ route('register') }}" @else action="{{ route('createUser') }}" @endif
                            enctype="multipart/form-data">
                            @csrf
                            @auth
                                @if (!(Auth::user()->category->id == 2 || Auth::user()->category->id == 1))
                                    {{ Form::hidden('user_category_id', '1', ['id' => 'user_category_id']) }}
                                @else
                                    @if (Auth::user()->category->id == 1)
                                        {{ Form::hidden('user_category_id', '2', ['id' => 'user_category_id']) }}
                                    @endif
                                    @if (Auth::user()->category->id == 2)
                                        {{ Form::hidden('user_category_id', '3', ['id' => 'user_category_id']) }}
                                    @endif
                                @endif
                            @endauth
                                ...
                                @guest
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="category"
                                            ...
                                            value="{{ old('category') }}" onchange="catChange()">
                                            <option value="1" @if (old('category') == 1) selected @endif>
                                                {{ __('Company') }}</option>
                                            <option value="2" @if (old('category') == 2) selected @endif>
                                                {{ __('Agent') }}</option>
                                            {{-- <option value="3" @if (old('category') == 3) selected @endif>{{ __('Distrbutor') }}</option> --}}
                                            <option value="4" @if (old('category') == 4) selected @endif>
                                                {{ __('Free Distrbutor') }}</option>
                                            <option value="5" @if (old('category') == 5) selected @endif>
                                                {{ __('Pharmacist') }}</option>
                                        </select>
                                        @error('category')
                                ...
                                @auth
                                    @if (!(Auth::user()->category->id == 2 || Auth::user()->category->id == 1))
                                        <div class="col-md-6">
                                            <select class="form-control" id="category"
                                                class="form-control @error('category') is-invalid @enderror" name="category"
                                                value="{{ old('category') }}" onchange="catChange(true)">
                                                <option value="1" @if (old('category') == 1) selected @endif>
                                                    {{ __('Company') }}</option>
                                                <option value="2" @if (old('category') == 2) selected @endif>
                                                    {{ __('Agent') }}</option>
                                                <option value="3" @if (old('category') == 3) selected @endif>
                                                    {{ __('Distrbutor') }}</option>
                                                <option value="4" @if (old('category') == 4) selected @endif>
                                                    {{ __('Free Distrbutor') }}</option>
                                                <option value="5" @if (old('category') == 5) selected @endif>
                                                    {{ __('Pharmacist') }}</option>
                                                <option value="0" @if (old('category') == 0) selected @endif>
                                                    {{ __('Admin') }}</option>
                                            </select>
                                            @error('category')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    @else
                                        <div class="col-md-6">
                                            <select class="form-control disabled" id="category" class="form-control"
                            ...
                            <div class="form-group row @auth @if (!(Auth::user()->category->id == 2 || Auth::user()->category->id == 1)) d-none @endif @endauth"
                                id="s_name_div">
                            ...
                            <div class="form-group row @auth @if (!(Auth::user()->category->id == 2 || Auth::user()->category->id == 1)) d-none @endif @endauth"
                                id="commercial_name_div">
                                <label class="col-md-3 text-right"
                                    for="commercial_name">{{ __('Commercial Name') }}</label>
                                <div class="col-md-6">
                                    <input id="commercial_name" type="text"
                                        class="form-control @error('commercial_name') is-invalid @enderror"
                                        name="commercial_name" value="{{ old('commercial_name') }}">
                            ...
                            @guest
                                <div class="form-group row d-none" id="licence_number_div">
                                    <label class="col-md-3 text-right" for="licence_number">{{ __('Licence Number') }}
                                        *</label>
                                    <div class="col-md-6">
                                        <input id="licence_number" type="text"
                                            class="form-control @error('licence_number') is-invalid @enderror"
                                            name="licence_number" value="{{ old('licence_number') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="region" type="text"
                                        ...
                                        value="{{ old('region') }}" placeholder="{{ __('City') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="tel1" type="text"
                                        ...
                                        value="{{ old('tel1') }}" placeholder="{{ __('Telephone 1') }}">
                                ...
                                <div class="col-md-3">
                                    <input id="tel2" type="text"
                                        ...
                                        value="{{ old('tel2') }}" placeholder="{{ __('Telephone 2') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="mob1" type="text"
                                        class="form-control @error('mob1') is-invalid @enderror" name="mob1"
                                        value="{{ old('mob1') }}" placeholder="{{ __('Mobile 1') }} *" required>
                                ...
                                <div class="col-md-3">
                                    <input id="mob2" type="text"
                                        class="form-control @error('mob2') is-invalid @enderror" name="mob2"
                                        value="{{ old('mob2') }}" placeholder="{{ __('Mobile 2') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="fax1" type="text"
                                        ...
                                        value="{{ old('fax1') }}" placeholder="{{ __('Fax 1') }}">
                                ...
                                <div class="col-md-3">
                                    <input id="fax2" type="text"
                                        class="form-control @error('fax2') is-invalid @enderror" name="fax2"
                                        value="{{ old('fax2') }}" placeholder="{{ __('Fax 2') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email2" type="email"
                                        ...
                                        value="{{ old('email2') }}" autocomplete="email">
                            ...
                            @auth
                                            ...
                                            <select class="form-control" id="company"
                                                ...
                                                @foreach ($comps as $comp)
                                                    <option value="{{ $comp->id }}"
                                                        @if (old('company') == $comp->id) selected @endif>{{ $comp->f_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('company')
                                ...
                                @else
                                    <div class="form-group row" id="comps_div">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" id="comps"
