            ...
            @elseif(Auth::user()->user_category_id == 5)
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="number" placeholder="0" id="quantity{{ $item->id }}" min="0"
                            class="form-control form-control" name="quantity{{ $item->id }}" value="0"
                            onchange="quantityChange({{ $item->id }})" required>
                    </div>
                    <div class="col-md-4">
                        <label for="reciever_id{{ $item->id }}" class="float-left text-left">{{ __('Reciever') }}</label>
                        <select id="reciever_id{{ $item->id }}" class="form-control form-control"
                            name="reciever_id{{ $item->id }}" value="" required>
                    ...
                    <div class="col-12">
                        <button type="button" class="btn btn-primary disabled btn mt-2 float-right"
                            onclick="ajaxSendtoCart({{ $item->id }}, false)" disabled id="i_btn{{ $item->id }}">
                            {{ __('Add to Cart') }}
                        </button>
                    </div>
                </div>
